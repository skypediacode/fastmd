...
$Notes = "Native, lightning-fast Markdown and text editor for Windows with v1.7.2 improvements: expanded LaTeX math rendering with comprehensive symbol support, spacing macro handling, and improved command parsing. Download the portable zip to get started immediately without installation or the installer if you prefer the traditional Windows installation."
