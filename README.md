# FastMD: The Lightning-Fast, Native Markdown Editor for Windows
...
**FastMD** is an ultra-fast, native, and distraction-free Markdown editor designed specifically for Windows. Built from the ground up with **C++20** and **Qt 6 Widgets**, FastMD focuses on one thing: providing the absolute best typing performance and a frictionless writing experience. 
...
| **Idle RAM Usage** | 150 MB – 300 MB | **~25 MB** | ~10x lighter |
| **Cold Startup Time** | 2.0s – 4.0s | **< 0.1s** (Instant) | ~30x faster |

*Numbers are approximate averages based on common Chromium-based desktop text editors.*
...
FastMD is currently a Windows-exclusive application compiled with MSVC.
...
1. Clone the repository:
   ```powershell
   git clone https://github.com/yourusername/fastmd.git
   cd fastmd
   ```
...
## 🤝 Contributing
FastMD is an open-source project. If you are aligned with our philosophy of extreme speed and native execution, we welcome your pull requests! Please review our `AGENTS.md` and `HANDOFF.md` files to understand our architectural constraints before contributing.
...
*FastMD — Stop waiting on your editor. Start writing.*
